...
from kerbad.protocol.constants import NAME_TYPE, MESSAGE_TYPE, PaDataType
...
from kerbad.protocol.asn1_structs import KDC_REQ_BODY, PrincipalName, HostAddress, \
...
from kerbad.protocol.rfc4556 import PKAuthenticator, AuthPack, Dunno1, Dunno2, MetaData, Info, CertIssuer, CertIssuers, PA_PK_AS_REP, KDCDHKeyInfo
from kerbad.protocol.rfc_iakerb import KRB_FINISHED
from kerbad.protocol.mskile import LSAP_TOKEN_INFO_INTEGRITY, KERB_AD_RESTRICTION_ENTRY, KERB_AD_RESTRICTION_ENTRYS
...
class PKINIT:
	...
	def init_windows_cert(self, username, certstore_name = 'MY', cert_serial = None):
		from kerbad.common.windows.crypt32 import find_cert_by_cn
	...
	def sign_authpack(self, data, wrap_signed = False):
		if self.__hcert is not None:
			from kerbad.common.windows.crypt32 import pkcs7_sign
