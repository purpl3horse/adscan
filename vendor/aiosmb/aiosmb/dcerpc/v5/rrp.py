...
# Composite read mask: KEY_QUERY_VALUE | KEY_ENUMERATE_SUB_KEYS | STANDARD_RIGHTS_READ (0x20000).
# Compatible with SeBackupPrivilege — use this (not MAXIMUM_ALLOWED) when opening hives
# via REG_OPTION_BACKUP_RESTORE so Windows accepts the request from Backup Operators accounts.
KEY_READ               = 0x00020019
