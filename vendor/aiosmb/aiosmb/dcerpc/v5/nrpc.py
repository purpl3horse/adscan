...
def ComputeNetlogonCredentialAES(inputData, Sk):
	# MS-NRPC 3.1.4.4.1: AES-CFB8 with all-zero IV (segment_size=1 byte = 8 bits).
	# unicrypto.symmetric.AES uses MODE_CFB with segment_size in bits.
	IV = b'\x00' * 16
	Crypt1 = AES(Sk, MODE_CFB, IV=IV, segment_size=8)
