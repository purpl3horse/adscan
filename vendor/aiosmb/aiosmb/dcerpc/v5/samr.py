...
async def hSamrSetPasswordInternal4New(dce, userHandle, password):
	...
	# LogonHours is NOT included in WhichFields (0x01000000|0x08000000 = PasswordExpired+Password).
	# Setting it to NULL (int) triggers len(0) in SAMPR_LOGON_HOURS.__setitem__ — skip it.
